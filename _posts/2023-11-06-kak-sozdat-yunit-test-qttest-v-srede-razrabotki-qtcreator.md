...
![Диалог создания нового проекта в Qt Creator с выбором шаблона Subdirs Project](/assets/images/qt-unit-test/492c7798-191e-4785-82d9-faee8bcbb902.png)

Поэтому следующим шагом среда запрашивает создание первого подпроекта. Выбираем простое приложение на языке C++.

![Диалог создания подпроекта в Qt Creator с выбором шаблона Plain C++ Application](/assets/images/qt-unit-test/65bc86ae-7a66-45b2-bbbc-4f5822ce814f.png)

Мастер автоматически создаст шаблонное приложение.

![Шаблонный код main.cpp, созданный мастером Qt Creator для нового C++ приложения](/assets/images/qt-unit-test/b4a3348b-403c-4f59-a3a1-9a20d3a4ba48.png)
...
![Код main.cpp с использованием класса Calculator для сложения, вычитания, умножения и деления](/assets/images/qt-unit-test/b1e39adf-30e3-49f1-b55b-4ae1f67074e0.png)
...
![Диалог создания подпроекта юнит-теста с выбором шаблона Auto Test Project в Qt Creator](/assets/images/qt-unit-test/b2883f30-190f-44a9-9892-b324a56c83c8.png)
...
![Шаблонный код юнит-теста tst_tst_calculator.cpp, созданный мастером Auto Test Project](/assets/images/qt-unit-test/7f680189-d4c6-42be-9b14-49e10b3aa441.png)
...
![Код тест-метода testSum() с проверками QCOMPARE для класса Calculator](/assets/images/qt-unit-test/4bf16192-5a07-4d4e-8fa0-dd8cf2c603bc.png)
...
![Файл test.pro с добавленными в SOURCES и HEADERS исходниками класса Calculator](/assets/images/qt-unit-test/50f01bab-7bed-4ca6-92f9-9427875a5e6e.png)
...
![Панель Tests в Qt Creator со списком распознанных юнит-тестов testSum, testDif, testMul, testDiv](/assets/images/qt-unit-test/04cbfd18-55cc-489c-b9c4-c421d9bd336b.png)
...
![Контекстное меню запуска теста testSum в панели Tests Qt Creator](/assets/images/qt-unit-test/f296d41c-aa36-4a16-a372-7c213e7a20a4.png)
...
![Вкладка Test Results с результатами успешного прохождения всех юнит-тестов](/assets/images/qt-unit-test/d6c961c7-ebb8-434a-84b1-e36933069f7c.png)

В случае обнаружения несовпадений, QtCreator выведет описание проблемы и укажет, в какой строке она произошла.

![Вкладка Test Results с описанием ошибки FAIL в тест-методе testMul при несовпадении значений](/assets/images/qt-unit-test/e007f27f-5f09-401a-881f-f79f19faf34b.png)
