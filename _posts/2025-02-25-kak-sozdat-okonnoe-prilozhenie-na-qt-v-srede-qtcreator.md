...
![Диалог создания нового проекта Qt Widgets Application в QtCreator](/assets/images/qt-window/b95e5bf5-3033-4226-b54e-6027e45a5e34.png)
...
![Настройки класса MainWindow в мастере QtCreator со снятой галочкой Generate form](/assets/images/qt-window/0d92e8ff-f627-48db-98c2-3c67743054da.png)
...
![Запущенное окно приложения People с пустой таблицей и панелью ввода данных](/assets/images/qt-window/c9f113a7-590a-4e0e-bd87-e7d04d76ac5d.png)

Вводим данные и нажимаем кнопку “Add”. Новая запись появляется в таблице.

![Окно приложения People с добавленной в таблицу записью Ivan Ivanov, 12 лет](/assets/images/qt-window/2803374a-6453-49f0-b312-3d83338d5a24.png)
...
![Редактирование ячейки таблицы: имя изменяется с Ivan на Petr прямо в таблице](/assets/images/qt-window/5597caf2-f5ca-4954-942f-9e9e136ac6b3.png)
