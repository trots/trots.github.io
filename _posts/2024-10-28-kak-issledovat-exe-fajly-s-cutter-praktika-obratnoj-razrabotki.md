...
![Консоль cutter_example.exe с сообщением "Wrong password. Closing" после ввода неверного пароля 123](/assets/images/cutter-intro/04840c34-6311-49a5-b9ab-bf61f812fc0f.png)
...
![Диалог "Открыть файл" в Cutter с выбранным cutter_example.exe для анализа](/assets/images/cutter-intro/33472ccb-19a4-4c9d-92f2-439f24e30757.png)

В следующем окне выставляются настройки анализа. Можно ничего не менять и нажать ОК. Начнется анализ.

![Диалог "Параметры загрузки" Cutter с настройками уровня авто-анализа exe-файла](/assets/images/cutter-intro/963444c5-066d-4177-b960-300d627247eb.png)

Через некоторое время Cutter покажет окно с дизассемблированным кодом.

![Окно Cutter с дизассемблированным кодом cutter_example.exe после анализа](/assets/images/cutter-intro/1e2f0aec-7c3e-4e0f-8042-7fd3138e987f.png)
...
![Вкладка Strings в Cutter с результатом поиска по фильтру "password"](/assets/images/cutter-intro/afd75af4-c96d-48bb-835c-b7a017873338.png)
...
![Окно перекрёстных ссылок Cutter с единственным использованием строки в инструкции lea](/assets/images/cutter-intro/e28f9495-b7f0-4632-95e2-1bebe9726992.png)
...
![Дизассемблированный код функции main с инструкцией cmp и строкой пароля str.123456](/assets/images/cutter-intro/41d73a27-7a6c-4a4c-8fca-947de0177818.png)

Запускаем cutter\_example.exe и пробуем ввести пароль "123456". Как и ожидалось, все получилось!

![Консоль cutter_example.exe с сообщением "Hello admin!" после ввода найденного пароля 123456](/assets/images/cutter-intro/94d5d7c8-89fd-4ed5-8dbe-021667cdcefc.png)
...
![Контекстное меню замены инструкции jne на nop через пункт "Редактировать" в Cutter](/assets/images/cutter-intro/b26a806d-4c10-4efa-aa05-b6ae0828e08d.png)

При изменении может выскочить окно с подтверждением перехода в режим записи. Подтверждаем.

![Диалог "Ошибка записи" с предложением переоткрыть файл в режиме записи в Cutter](/assets/images/cutter-intro/d57776c8-f5ab-4006-b993-51e3548173dc.png)
...
![Дизассемблированный код с первой замененной инструкцией jne на два nop и вторым условным прыжком jne](/assets/images/cutter-intro/feb7ac92-1a77-433d-98ff-92c50abe435c.png)

Получаем такую картину.

![Дизассемблированный код после замены обеих инструкций jne на nop-ы](/assets/images/cutter-intro/b90ac2b8-dea2-4531-8d51-534b77e1ffa0.png)
...
![Консоль пропатченного cutter_example.exe с сообщением "Hello admin!" при вводе неверного пароля 1234](/assets/images/cutter-intro/94ed8647-1817-46ba-a0c2-1da9a1bfc080.png)
