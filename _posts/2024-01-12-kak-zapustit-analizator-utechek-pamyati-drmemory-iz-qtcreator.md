...
![Создание новой конфигурации запуска Custom Executable в настройках проекта QtCreator](/assets/images/dr-memory-run/3201b167-f68b-472e-9018-b669902a64e4.png)
...
![Переименование конфигурации запуска в DrMemoryRunner в QtCreator](/assets/images/dr-memory-run/b5e7d752-f562-4425-9422-c19626a77dd5.png)
...
![Заполнение параметров конфигурации запуска: путь к drmemory.exe, аргументы командной строки и рабочая директория](/assets/images/dr-memory-run/e56f7d55-09ae-4704-9f04-8719cdf3f3df.png)
...
![Добавление пути к библиотекам в переменную окружения Path через Append path в QtCreator](/assets/images/dr-memory-run/632d5cab-cafe-43a5-ba8b-9984a19ef4e0.png)
...
![Переключение QtCreator на конфигурацию запуска DrMemoryRunner в панели выбора конфигураций](/assets/images/dr-memory-run/a72020c3-b3fb-4838-b1e4-6d91546e7762.png)
...
![Консольный вывод DrMemory на вкладке Terminal QtCreator с найденной утечкой памяти на 4 байта](/assets/images/dr-memory-run/5b097293-a587-480f-bfa3-ad692829dacd.png)
...
![Блок ERROR LEAK со стеком вызовов и строкой кода, в которой произошла утечка памяти](/assets/images/dr-memory-run/ea96d107-cbf6-43f8-aee6-6ca59473c434.png)
...
![Файл results.txt, автоматически открываемый Блокнотом по завершении анализа DrMemory](/assets/images/dr-memory-run/3fabef94-5656-4eb4-ab30-e0045b879191.png)

![Ключ --batch, добавленный в аргументы командной строки для отключения автозапуска Блокнота](/assets/images/dr-memory-run/6140173f-289c-4792-b207-0506fdc4b8fc.png)
