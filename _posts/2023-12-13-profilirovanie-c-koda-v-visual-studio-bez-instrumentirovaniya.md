...
![Стартовый экран Visual Studio 2022 со ссылкой "Продолжить без кода"](/assets/images/cpp-profile-vs/a5ba8807-7826-4be5-b349-da7240ca062b.png)

Переходим к запуску профилировщика производительности.

![Запуск профилировщика производительности через меню Отладка → Окна в Visual Studio](/assets/images/cpp-profile-vs/26271c5c-c441-4eaf-846d-4aa1e622dbcb.png)

В качестве целевого объекта выбираем "Исполняемый файл".

![Выбор целевого объекта анализа "Исполняемый файл" в профилировщике Visual Studio](/assets/images/cpp-profile-vs/c6c87ba7-b02a-4d61-a4f3-0e2afc88e794.png)
...
![Настройка пути к исполняемому файлу и рабочей папки для запуска профилировщика](/assets/images/cpp-profile-vs/d072aefd-0c81-4621-a4ec-8a6ffc43502e.png)
...
![Выбор режима "Использование ЦП" и запуск профилирования без инструментирования](/assets/images/cpp-profile-vs/635af341-ec66-4657-90d7-05a82e0b6900.png)
...
![Отчет профилировщика с таблицей критического пути вызовов функции WriteFile2](/assets/images/cpp-profile-vs/fb8b7759-d0ff-4078-845c-4bb1f5cc5245.png)
...
![Представление функции WriteFile2 с указанием строки открытия файла, занимающей 84,48% времени выполнения](/assets/images/cpp-profile-vs/1743b601-daea-4e94-bcc9-b0588fff051f.png)
...
![Отчет повторного профилирования после оптимизации: общее время ЦП снизилось с 6159 до 3 единиц](/assets/images/cpp-profile-vs/f3873461-27d2-4e11-adf4-d439eaba8d2c.png)
